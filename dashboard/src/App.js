  ...
  return (
    <div className="App">
      <header className="App-header text-center py-4 bg-blue-500">
        <div
          className={`mx-0 text-left opacity-100 transition-opacity duration-1000 delay-6000 pl-4 ${isVisible ? '' : 'hidden'
            }`}
        >
          <span className='desc'>CSV File Must Contain following fields</span>
          <ul>
            <li>
              <b>*firstName</b>
            </li>
